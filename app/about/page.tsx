          ...
          <div className="grid lg:grid-cols-12 gap-x-12 gap-y-8">
            ...
            <div className="lg:col-span-8 space-y-5 text-[17px] leading-[1.7] text-[var(--color-ink-dim)] max-w-2xl">
              ...
              <p className="text-[var(--color-ink)]">
                ...
                <a href="/products/command-center" className="text-[var(--color-accent)] underline underline-offset-4 decoration-[var(--color-rule-strong)] hover:decoration-[var(--color-accent)] transition-colors">Command Center</a>
